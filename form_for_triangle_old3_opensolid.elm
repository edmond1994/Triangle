...
view model =
  div []
    [
      ...
      [
        Html.text "Vertice 1: "
        , input [ Html.Attributes.type_ "text", placeholder "Input X", onInput X1 ] []
        , input [ Html.Attributes.type_ "text", placeholder "Input Y", onInput Y1 ] []
      ],
      div []
      [
        Html.text "Vertice 2: "
        , input [ Html.Attributes.type_ "text", placeholder "Input X", onInput X2 ] []
        , input [ Html.Attributes.type_ "text", placeholder "Input Y", onInput Y2 ] []
      ],
      div []
      [
        Html.text "Vertice 3: "
        , input [ Html.Attributes.type_ "text", placeholder "Input X", onInput X3 ] []
        , input [ Html.Attributes.type_ "text", placeholder "Input Y", onInput Y3 ] []
      ],
      div []
      [
        Html.text "Point:  "
        , input [ Html.Attributes.type_ "text", placeholder "Input X", onInput X0 ] []
        , input [ Html.Attributes.type_ "text", placeholder "Input Y", onInput Y0 ] []
      ],
      div []
      [
        Html.text "Result:  ",
